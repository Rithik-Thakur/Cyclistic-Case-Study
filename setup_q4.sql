--Joined October, november and december
--followed same rules as q1, q2 and q4
CREATE TABLE `data-analytics-learner.2024_cyclistic_cs.2024_q4_tripdata` AS
WITH combined_data AS (
    SELECT *
    FROM `data-analytics-learner.2024_cyclistic_cs.202410_tripdata`
    UNION DISTINCT
    SELECT *
    FROM `data-analytics-learner.2024_cyclistic_cs.202411_tripdata`
    UNION DISTINCT
    SELECT *
    FROM `data-analytics-learner.2024_cyclistic_cs.202412_tripdata`
)
