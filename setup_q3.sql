--Joined July,august and september
--followed same rules as q1 and q2
CREATE TABLE `data-analytics-learner.2024_cyclistic_cs.2024_q3_tripdata` AS
WITH combined_data AS (
    SELECT *
    FROM `data-analytics-learner.2024_cyclistic_cs.202407_tripdata`
    UNION DISTINCT
    SELECT *
    FROM `data-analytics-learner.2024_cyclistic_cs.202408_tripdata`
    UNION DISTINCT
    SELECT *
    FROM `data-analytics-learner.2024_cyclistic_cs.202409_tripdata`
)
